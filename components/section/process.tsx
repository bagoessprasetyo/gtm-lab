...
export default function Process({
    ...
    return (
        <div
            ...
            <div className="container flex flex-col gap-6 px-4 mx-auto lg:px-0 lg:grid lg:grid-cols-12 lg:gap-20">
            ...
            {showAboutSection && (
                <div className="container px-4 mx-auto mt-8 lg:mt-12 lg:px-0">
                    <div
                        className="flex flex-col gap-6 px-6 py-4 text-white bg-black lg:flex-row lg:justify-between lg:items-center lg:px-6 lg:py-4"
                        data-aos="fade-in">
