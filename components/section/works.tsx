...
export default function Works({
    ...
    return (
        <div className={cn('py-10 box box-works lg:py-20', className)}>
            <div className="container flex flex-col gap-10 px-4 mx-auto lg:px-0 lg:grid lg:grid-cols-12 lg:gap-20">
                <div className="relative lg:col-span-5">
                    <div className="sticky flex flex-col w-full gap-6 lg:gap-8 top-28">
                        <div className="flex flex-col max-w-3xl gap-4 header-area">
                            ...
                            {link && (
                                <div
                                    className="flex flex-col items-start gap-4 mt-2 lg:mt-4 entry-main-button"
                                    data-aos="fade-in">
                                    <Button
                                        size="lg"
                                        asChild
